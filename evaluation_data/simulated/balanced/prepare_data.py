...
for lab in ['lab1', 'lab2', 'lab3']:
    ...
    base_path = Path(f'/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/simulated/balanced/before/{lab}')
...
after_path = Path('/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/simulated/balanced/after/individual_results')
...
for idx, lab in enumerate(['lab1', 'lab2', 'lab3']):
    ...
    design_path = Path(f'/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/simulated/balanced/before/{lab}')
