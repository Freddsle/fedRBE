...
for lab in ['lab_A', 'lab_B', 'lab_C', 'lab_D', 'lab_E']:
    ...
    base_path = Path(f'/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/proteomics/before/{lab}')
    ...
    # Add Pyr column from design (the target variable for proteomics)
    data['Pyr'] = design['Pyr']
...
after_path = Path('/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/proteomics/after/individual_results')
...
for idx, lab in enumerate(['lab_A', 'lab_B', 'lab_C', 'lab_D', 'lab_E']):
    ...
    design_path = Path(f'/home/jk/featurecloudALL/apps/fedRBE/evaluation_data/proteomics/before/{lab}')
    design = pd.read_csv(design_path / 'design.tsv', sep='\t', index_col=0)

    # Add Pyr column from design - match by index
    corrected_data['Pyr'] = design.loc[corrected_data.index, 'Pyr']
