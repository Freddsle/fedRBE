...
5. `05_create_merged_omics_folder.py` — creates a merged folder (`merged_omics`) with the structure `<after||before>/<client>`, containing all modalities for each client merged. Creates this based on the previous scripts output!
